...
public class MovieData {
    ...
    public static List<Map<String,?>> moviesList;
	...
	public void addMovie(int position) {
		HashMap original = (HashMap) moviesList.get(position);



		HashMap movie = original;

		moviesList.add(position+1, movie);
	...
	public void addToList(int num , Map<String,?> movie) {
		moviesList.add(num,movie);
	}
